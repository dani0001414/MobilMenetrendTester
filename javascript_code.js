...
var hm ="Megérkezetett hozzád az új "+scriptVersion+" verzió amely az alábbi új funkciókat tartalmazza:<br>";
var newScriptMessage = hm+"Menetrendi események napok szerinti kategorizálása a még kényelmesebb használatért!";
...
function modal_open(i) {
    ...
    if (i == "newScriptLoaded") {
        var textContent = "<div style=\"max-width:400px\" align=\"left\"><font size=\"2\">"+newScriptMessage+"</font></div><br><br>";
